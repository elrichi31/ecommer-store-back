...
import { Container, Heading, Text, Button, DropdownMenu, IconButton, Drawer, Label, clx } from "@medusajs/ui"
...
const CategoryImageWidget = ({ data }: DetailWidgetProps<AdminProductCategory>) => {
  ...
  // Load from category's native metadata
  useEffect(() => {
    if (data?.metadata) {
  ...
  const hasContent = !!savedImageUrl
        ...
        <Drawer.Content className="z-50 right-0">
          ...
          <Drawer.Body className="flex flex-col gap-y-6 p-6">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <Text className="text-ui-fg-muted text-xs">
                This image will be displayed in your storefront.
              </Text>
            </div>
          </Drawer.Body>
